...
{
	public class ArmyShip : Vehicle, IEquatable<ArmyShip>
	{
		/// <summary>
		...
		/// <summary>
		/// Метод интерфейса IEquatable для класса ArmyShip
		/// </summary>
		/// <param name="other"></param>
		/// <returns></returns>
		public bool Equals(ArmyShip other)
		{
			if (other == null)
			{
				return false;
